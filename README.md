...
- downstream deterministic operations include cubic curve handles, seam-allowance offsets, explicit grading translations, dimensional constraints, reference comparison, and an inspection-only DXF-style export.
